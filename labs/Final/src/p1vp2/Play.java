...
public class Play extends JFrame { //no cuenta la primera linea al ganar   //no se activan los 2 botones superiores
	...
	private boolean bloqueo[][]; //  fila true
	private boolean color[][]; // ganador
	private boolean p=true; //dice que jugador sigue
